...
public class BackgroundSizeHandler : MonoBehaviour
{
    ...
    private void ResizeSpriteToScreen()
    {
        ...
        var worldScreemHeight = Camera.main.orthographicSize * 2.0;
        var worldScreenWidth = worldScreemHeight/Screen.height * Screen.width;
        float myX =  (float)worldScreenWidth/width;
        float myY =  (float)worldScreemHeight/ height;
